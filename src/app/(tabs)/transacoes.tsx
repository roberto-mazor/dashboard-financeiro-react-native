...
export default function TransacoesScreen() {
  ...
  const transacoesFiltradas = transacoes.filter((item) => {
    ...
    const nomeCat = extrairNomeCategoria(item).toLowerCase();
    const nomeCard = (extrairNomeCartao(item) || '').toLowerCase();
    const matchBusca =
      !termo ||
      item.descricao.toLowerCase().includes(termo) ||
      nomeCat.includes(termo) ||
      nomeCard.includes(termo);
                ...
                <View style={styles.itemEsquerda}>
                  ...
                  <View style={styles.infoTransacao}>
                    ...
                    <View style={styles.metaTransacao}>
                      ...
                      {/* TAG / BADGE DE CARTÃO DE CRÉDITO */}
                      {nomeCartao && (
